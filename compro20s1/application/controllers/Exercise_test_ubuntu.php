 ...
 */
class Exercise_test_ubuntu extends CI_Controller {
	public $compiler ='C:\TinyC\tcc.exe ';
	
	public function __construct() {
		//parent::__construct();
		//echo __METHOD__."<br>";
		//echo "<pre>";
		//print_r(system('C:\TinyC\tcc.exe'));
		//echo "</pre>";
		//echo "<pre>";
		//print_r($_SESSION);
		//echo "</pre>";
	...
	public function get_exercise_output($sourcecode_filename,$testcase_content) {
		...
		$cmd = 'C:\TinyC\tcc.exe ' ;
		$cmd .= SUPERVISOR_CFILES_FOLDER.$sourcecode_filename;
		$option = ' -run ';
