...
<div class="col-lg-10 col-md-10 col-sm-10" style="margin-top:100px;">
	<?php 
		...
		echo 'class_info : <pre>';			print_r($class_info);		echo '</pre><br/>';
		echo 'group_permission : <pre>';	print_r($group_permission);	echo '</pre><br/>';
		echo 'lab_data : <pre>';			print_r($lab_data);			echo '</pre><br/>';
		echo 'student_data : <pre>';	print_r($student_data);			echo '</pre><br/>';
		echo ' -->';
	?>

	<div class="row">
		<div class="container">
			 <button type="button" class="btn btn-primary btn-lg"  style="background-color:#E5A9D6;margin:10px 10px;"><h2>Exercise list for all chapters.</h2></button>
