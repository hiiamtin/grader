		...
		<div class="panel panel-default">
			...
			<div class="panel-body" style="font-size:20px">
				...
				<ol>
					...
					<li>เพื่อการแสดงผลที่ดี แนะนำให้ใช้ Google Chrome </li>
					<li>นักศึกษาต้องเขียนโปรแกรมให้เครื่องตัวเอง แล้วอัพโหลด source code (filename.c) เข้าไปในระบบ</li>
					...
					<li>ให้นักศึกษาตรวจสอบว่า กลุ่มที่ ถูกต้องหรือไม่ (อยุ่ด้านซ้ายใต้รูป) ถ้าไม่ถูกต้องให้แจ้งอาจารย์ ใช้เวลาแก้ไขไม่เกินหนึ่งอาทิตย์</li>
					<li>ห้ามใช้คำสั่ง getch()</li>
					<li>แต่ละบทจะมีแบบฝึกหัด 5 ข้อ คะแนน ข้อละ 2 คะแนน</li>
					...
					<li>คำสั่งที่ไม่มีในบทเรียน ไม่แนะนำให้ใช้ ถ้าใช็นักศึกษาจะต้องรับความเสี่ยงกรณีที่ตรวจแล้วไม่ได้คะแนน</li>
