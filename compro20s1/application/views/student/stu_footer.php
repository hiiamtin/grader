		...
		<!-- footer start -->
		<footer class="container-fluid" style="background-color:LightSteelBlue;border:2px blue;margin-left:150px;margin-right:0px;padding-left:10%;text-align:center;">
