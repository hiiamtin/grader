...
<div class="col-lg-2 col-md-2 col-sm-2 sidenav  text-center" style="padding-top:0px;margin-left:-20px; background-color: ghostwhite ">
	<div class="affix" style="background-color:Pink; min-width: 15%; "><!-- -->
		...
		<div class="panel panel-default" style="background-color:AliceBlue; height:1024px;">
			<img src="<?php echo $student_data['stu_avatar'] ? base_url(STUDENT_AVATAR_FOLDER.$student_data['stu_avatar']) : base_url(STUDENT_AVATAR_FOLDER.'user.png'); ?>" style="width:180px;padding-top:20px">
