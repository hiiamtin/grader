		...
		<div class="row">
			...
			<div class="col-sm-2">
				<div class="well" style="margin-top:20px; display:flex">
					...
					<button type="button" class="btn btn-primary" data-toggle="modal" style="margin-left:10px;" data-target="<?php echo '#'.$modal_name; ?>" >COPY TO</button>
                        ...
                        <div class="modal-body" style="display:flex;margin-left:10px;">                            
							...
							<select class="custom-select" name="level">
								...
								<option value=<?php echo '"'.$level.'" '; 
									if ( $level==$lab_level) 
										echo 'selected';?>><?php echo $level; ?></option><?php }	?>
							</select> 
                        </div>
                        <div class="modal-footer">
                            <button form="<?php echo $form_id; ?>" type="submit" onclick="prompt('COPY TO')" class="btn btn-success">submit</button>
                        </div>
                    </form>
                </div>
            </div>
