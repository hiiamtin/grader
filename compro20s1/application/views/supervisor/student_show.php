						...
						<tbody>
							...
							<?php
								...
								foreach ($group_permission as $row) {
									...
									$error_time = $this->session->flashdata("error_time".$row['chapter_id']); ?>
									...
									<?php echo $error_time ? $error_time : '' ?>
										...
										echo '<form action='.site_url('supervisor/time_open_and_close');
										echo ' id="time_open_and_close" method="post" id="set_time_open_and_close">'; # target="_blank"
										...
										echo '<button type="button submit" id="update_time" class="btn btn-primary">update time</button>';
										echo '<script>
